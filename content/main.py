...
# Organization · WebPage · BreadcrumbList · FAQPage 만 사용한다.
from .site import BASE_URL, BRAND, PHONE, PHONE_DISPLAY
from .pricing import PRICING

_NAVER = '<meta name="naver-site-verification" content="4fcb8ac2993e2251985d1de8d5b92e7866d27d89" />\n'
...
{{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "강동 출장마사지·홈타이 지역별 예약 안내",
  "url": "{BASE_URL}/",
  "description": "강동 출장마사지·홈타이 예약 전 행정동, 역세권, 이용 기준 안내",
  "inLanguage": "ko-KR",
  "isPartOf": {{
    "@type": "WebSite",
    "name": "{BRAND}",
...
{{
  ...
  "mainEntity": [
    {{
      ...
      "acceptedAnswer": {{
        "@type": "Answer",
        "text": "예약 시간, 정확한 위치, 배정 상황에 따라 가능 여부가 달라집니다. 대표 행정동 안내 페이지에서 강일동, 상일동, 명일동, 고덕동, 암사동, 천호동, 성내동, 길동, 둔촌동 기준으로 확인할 수 있습니다."
      }}
    }},
    {{
      "@type": "Question",
      "name": "천호역이나 고덕역 근처도 가능한가요?",
      "acceptedAnswer": {{
        "@type": "Answer",
        "text": "주요 역세권은 역 상세 페이지에서 주변 생활권과 함께 안내합니다. 환승역도 노선별로 페이지를 나누지 않고 역마다 한 페이지로 운영하며, 정확한 가능 여부는 예약 시 위치를 기준으로 확인합니다."
      }}
    }},
    {{
      "@type": "Question",
      ...
      "acceptedAnswer": {{
        "@type": "Answer",
        "text": "번호가 붙은 행정동은 천호동, 성내동, 암사동, 고덕동, 명일동, 상일동, 둔촌동 대표 페이지에서 통합 안내하여 중복 페이지 위험을 줄입니다."
      }}
    }},
    {{
      "@type": "Question",
      "name": "강동 홈타이는 출장마사지와 다른가요?",
      "acceptedAnswer": {{
        "@type": "Answer",
        "text": "홈타이는 자택·숙소·사무실 인근으로 방문해 받는 방문형 관리를 가리키는 말로, 출장마사지와 같은 방식입니다. 예약 가능 여부를 먼저 확인한 뒤 이용하시면 됩니다."
      }}
    }},
    {{
      "@type": "Question",
...
<ul class="card-grid">
<li><a href="/gangdong/gangil-dong-chuljangmassage/">강일동</a></li>
<li><a href="/gangdong/sangil-dong-chuljangmassage/">상일동</a></li>
<li><a href="/gangdong/myeongil-dong-chuljangmassage/">명일동</a></li>
<li><a href="/gangdong/godeok-dong-chuljangmassage/">고덕동</a></li>
<li><a href="/gangdong/amsa-dong-chuljangmassage/">암사동</a></li>
<li><a href="/gangdong/cheonho-dong-chuljangmassage/">천호동</a></li>
<li><a href="/gangdong/seongnae-dong-chuljangmassage/">성내동</a></li>
<li><a href="/gangdong/gil-dong-chuljangmassage/">길동</a></li>
<li><a href="/gangdong/dunchon-dong-chuljangmassage/">둔촌동</a></li>
</ul>
...
<ul class="card-grid">
<li><a href="/gangdong/cheonho-station-chuljangmassage/">천호역</a></li>
<li><a href="/gangdong/gangdong-station-chuljangmassage/">강동역</a></li>
<li><a href="/gangdong/gil-dong-station-chuljangmassage/">길동역</a></li>
<li><a href="/gangdong/gubeundari-station-chuljangmassage/">굽은다리역</a></li>
<li><a href="/gangdong/myeongil-station-chuljangmassage/">명일역</a></li>
<li><a href="/gangdong/godeok-station-chuljangmassage/">고덕역</a></li>
<li><a href="/gangdong/sangildong-station-chuljangmassage/">상일동역</a></li>
<li><a href="/gangdong/gangil-station-chuljangmassage/">강일역</a></li>
<li><a href="/gangdong/dunchon-dong-station-chuljangmassage/">둔촌동역</a></li>
<li><a href="/gangdong/amsa-station-chuljangmassage/">암사역</a></li>
<li><a href="/gangdong/amsa-history-park-station-chuljangmassage/">암사역사공원역</a></li>
<li><a href="/gangdong/gangdong-gu-office-station-chuljangmassage/">강동구청역</a></li>
</ul>
</section>
